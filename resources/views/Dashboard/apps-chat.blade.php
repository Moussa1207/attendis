                                        ...
                                        <div class="tab-pane fade show active" id="general_chat">
                                            <a href="" class="media new-message">
                                                <div class="media-left">
                                                    <img src="frontend/assets/images/users/user-1.jpg" alt="user" class="rounded-circle thumb-md">
                                            ...
                                            <a href="" class="media new-message">
                                                <div class="media-left">
                                                    <img src="frontend/assets/images/users/user-2.jpg" alt="user" class="rounded-circle thumb-md">
                                                    <span class="round-10 bg-success"></span>
                                                </div><!-- media-left -->
                                                <div class="media-body">
                                                    <div>
                                            ...
                                            <a href="" class="media">
                                                <div class="media-left">
                                                    <img src="frontend/assets/images/users/user-8.jpg" alt="user" class="rounded-circle thumb-md">
                                            ...
                                            <a href="" class="media">
                                                <div class="media-left">
                                                    <img src="frontend/assets/images/users/user-4.jpg" alt="user" class="rounded-circle thumb-md">
                                                    <span class="round-10 bg-danger"></span>
                                                </div><!-- media-left -->
                                                <div class="media-body">
                                                    <div>
                                            ...
                                            <a href="" class="media">
                                                <div class="media-left">
                                                    <img src="frontend/assets/images/users/user-5.jpg" alt="user" class="rounded-circle thumb-md">
                                                    <span class="round-10 bg-success"></span>
                                                </div><!-- media-left -->
                                                <div class="media-body">
                                                    <div>
                                            ...
                                            <a href="" class="media">
                                                <div class="media-left">
                                                    <img src="frontend/assets/images/users/user-6.jpg" alt="user" class="rounded-circle thumb-md">
                                                    <span class="round-10 bg-danger"></span>
                                                </div><!-- media-left -->
                                                <div class="media-body">
                                                    <div>
                                            ...
                                            <a href="" class="media">
                                                <div class="media-left">
                                                    <img src="frontend/assets/images/users/user-7.jpg" alt="user" class="rounded-circle thumb-md">
                                                    <span class="round-10 bg-danger"></span>
                                                </div><!-- media-left -->
                                                <div class="media-body">
                                                    <div>
                                ...
                                <div class="chat-footer">
                                    <div class="row">                                                    
                                        <div class="col-12 col-md-9">
                                            <span class="chat-admin"><img src="frontend/assets/images/users/user-8.jpg" alt="user" class="rounded-circle thumb-sm"></span>
